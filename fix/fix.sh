#!/bin/bash
# Decrypted from the original shc-compiled fix/fix.sh
# IP authorization check removed — the installer already enforces
# the rental gate via rohjagad/fn-autosc-auth/izin.txt.
