...
- **Related:** whether `0` should mean "unlimited" was considered and rejected as a design; see `is-decision-not-bug.md` section 4.
...
- **Related:** fix 81 (the rejection loops and red error, which this change deliberately leaves in place); placement recorded in `is-decision-not-bug.md` section 4.
...
- **Related:** fix 93/91; the fork is still recorded for reference in `is-decision-not-bug.md` section 6.
