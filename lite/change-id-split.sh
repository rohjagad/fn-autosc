...
send_log() {
    ...
    TEXT="
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
<b>⚠️ X-RAY Split Change UUID ⚠️</b>
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
...
usernames=($(grep "^### " /etc/xray/json/split.json | awk '{print $2}' | sort | uniq))

# Clear screen and display header
clear
echo -e "${CYAN}========================================="
echo -e "${GREEN}          Change UUID X-ray Split"
echo -e "${CYAN}========================================="
...
# GET OLD UUID
old=$(grep "${user}" /etc/xray/json/split.json | awk -F'"id": "' '{print $2}' | awk -F'"' '{print $1}' | sort | uniq | strings)
