...
send_log() {
    ...
    TEXT="
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
<b>⚠️ X-RAY SPLIT LOCKED ACOUNT ⚠️</b>
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
...
locked_files=$(ls /var/log/create/xray/split/*.log 2>/dev/null)

if [ -n "$locked_files" ]; then
    clear
    echo -e "${NC}${separator}
        LOCK X-RAY SPLIT ACCOUNT
${separator}"
...
uuid=$(grep "UUID" /var/log/create/xray/split/${name}.log | awk '{print $3}')
exp2=$(grep "Expired" /var/log/create/xray/split/${name}.log | awk '{print $3}')
protokol2=$(grep "Protokol:" /var/log/create/xray/split/${name}.log | awk '{print $2}')
