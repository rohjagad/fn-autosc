...
send_log() {
    ...
    TEXT="
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
<b>⚠️ X-RAY WS UNLOCK ACOUNT ⚠️</b>
<b>━━━━━━━━━━━━━━━━━━━━━━━</b>
...
locked_files=$(ls /var/log/create/xray/ws/*.locked 2>/dev/null)

if [ -n "$locked_files" ]; then
    clear
    echo -e "${NC}${separator}
       UNLOCK X-RAY WS ACCOUNT
${separator}"
...
uuid=$(grep "UUID" /var/log/create/xray/ws/${name}.locked | awk '{print $3}')
exp2=$(grep "Expired" /var/log/create/xray/ws/${name}.locked | awk '{print $3}')
protokol2=$(grep "Protokol:" /var/log/create/xray/ws/${name}.locked | awk '{print $2}')
